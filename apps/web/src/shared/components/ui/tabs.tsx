...
function TabsList({ className, ...props }: TabsPrimitive.List.Props) {
  return (
    <TabsPrimitive.List
      data-slot="tabs-list"
      className={cn(
        "group/tabs-list inline-flex w-fit max-w-full items-center gap-1 overflow-x-auto rounded-2xl border border-border/50 bg-muted/30 p-1.5 text-muted-foreground shadow-sm backdrop-blur-md group-data-vertical/tabs:h-fit group-data-vertical/tabs:flex-col",
        className,
      )}
      {...props}
    />
